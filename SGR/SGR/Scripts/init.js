...
****************************************************************************************************/
    ...
    window.alertnotify = function(success, message) {
        if (success) {
            $(".page-title").append('<div class="alert alert-success"><button data-dismiss="alert" class="close"></button>' + message + '</div>');
        } else {
            $(".page-title").append('<div class="alert alert-error"><button data-dismiss="alert" class="close"></button>' + message + '</div>');
        }
    }
})